...
export const INITIAL_CONTENT = [
  { id: 1, partnerId: "maccas", name: "Summer Campaign Hero", filename: "maccas_summer_hero_1920x1080.mp4", type: "video/mp4", size: 12400000, status: "live", uploaded: "2026-04-01", reviewed: "2026-04-02" },
  { id: 2, partnerId: "maccas", name: "McDelivery Promo", filename: "maccas_mcdelivery_1920x1080.png", type: "image/png", size: 2100000, status: "approved", uploaded: "2026-04-10", reviewed: "2026-04-11" },
  { id: 3, partnerId: "maccas", name: "Happy Meal Spring", filename: "maccas_happymeal_spring.mp4", type: "video/mp4", size: 18700000, status: "pending", uploaded: "2026-04-17", reviewed: null },
  { id: 4, partnerId: "maccas", name: "Breakfast Range", filename: "maccas_breakfast_1920x1080.png", type: "image/png", size: 3400000, status: "rejected", uploaded: "2026-04-05", reviewed: "2026-04-06", rejectReason: "Image resolution is 1280x720. Required: 1920x1080." },
  { id: 5, partnerId: "maccas", name: "McCafe Autumn", filename: "maccas_mccafe_autumn.mp4", type: "video/mp4", size: 15200000, status: "live", uploaded: "2026-03-20", reviewed: "2026-03-21" },
  { id: 6, partnerId: "iren", name: "Iren Brand Awareness", filename: "iren_brand_1920x1080.mp4", type: "video/mp4", size: 14200000, status: "pending", uploaded: "2026-04-16", reviewed: null },
  { id: 7, partnerId: "iren", name: "Iren Solar Promo", filename: "iren_solar_1920x1080.png", type: "image/png", size: 2800000, status: "live", uploaded: "2026-03-28", reviewed: "2026-03-29" },
  { id: 8, partnerId: "sapol", name: "Road Safety Campaign", filename: "sapol_roadsafety_1920x1080.mp4", type: "video/mp4", size: 16500000, status: "pending", uploaded: "2026-04-18", reviewed: null },
  { id: 9, partnerId: "disney", name: "Disney+ Streaming", filename: "disney_streaming_1920x1080.mp4", type: "video/mp4", size: 11000000, status: "approved", uploaded: "2026-04-12", reviewed: "2026-04-13" },
  { id: 10, partnerId: "afl", name: "AFL Season 2026", filename: "afl_season2026_1920x1080.mp4", type: "video/mp4", size: 19500000, status: "live", uploaded: "2026-03-15", reviewed: "2026-03-16" },
];
...
export const INITIAL_EVENTS = [
  {
    ...
    zonePriority:    {},
    // CDP-037 — Zone × moment assignments.
    // McDonald's owns all Goal moments in Concourse and Gate 1.
    // Disney+ owns Goal moments in Corporate Suites.
    // McDonald's owns Mark moments in Concourse only.
    // All other combinations unassigned — available inventory for commercial team.
    moments: [
      // Goal Replay
  ...
  },
  {
    ...
    partnerPriority: ['maccas', 'afl', 'iren1', 'iren2', 'sapol', 'disney'],
    zonePriority:    {},
    // CDP-037 — All zone × moment combinations unassigned (full available inventory)
    moments: [
...
export const INITIAL_ALLOCATIONS = [
  // ── evt-001: Port Adelaide vs Richmond ──
  {
    ...
    contentSpec: CONTENT_SPECS_BY_FORMAT.fullscreen,
    contentItemId: null,
  ...
  },
  {
    ...
    slotCount: 4,
    displayFormat: 'lwrap',
    contentSpec: CONTENT_SPECS_BY_FORMAT.lwrap,
    contentItemId: null,
    status: 'pending_content',
...
export const INITIAL_CAMPAIGNS = [
  {
    id:          'cmp-001',
    name:        "McDonald's AFL Season 2026",
    partnerId:   'maccas',
    startDate:   '2026-03-01',
    endDate:     '2026-09-30',
    status:      'active',
    eventIds:    ['evt-001', 'evt-002'],
    // Entitlement rules — partner × event type × zone.
    // zoneId: null = applies to all zones for that event type.
    // bonusPct: operator-assigned bonus above contracted entitlement.
    rules: [
      {
        id:              'rule-001',
        eventTypeId:     'afl',
        zoneId:          'concourse',
        entitlementType: 'percentage',
        value:           12,
        bonusPct:        2,
        notes:           "Maccas primary zone — high footfall, peak commercial value",
      },
      {
        id:              'rule-002',
        eventTypeId:     'afl',
        ...
        value:           10,
        bonusPct:        0,
        notes:           "Gate 1 — entry/exit audience",
      },
      {
        id:              'rule-003',
        eventTypeId:     'afl',
        ...
        value:           8,
        bonusPct:        0,
        notes:           "Members bar — premium audience, restricted slot count",
      },
      {
        id:              'rule-004',
        eventTypeId:     'afl',
        ...
        value:           5,
        bonusPct:        0,
        notes:           "Corporate suites — category presence only",
      },
      {
        id:              'rule-005',
        eventTypeId:     'non_event',
        zoneId:          null,   // all zones
        entitlementType: 'seconds',
        value:           360,    // 360s/hr = 12 × 30s slots per hour
        bonusPct:        0,
        notes:           "Background rotation — Mon–Sun, all zones, 12 slots/hr",
      },
    ],
    // Content pool — pieces available for this campaign period.
    // activeTo can expire a piece within the campaign without ending the campaign.
    contentPool: [
      {
        id:         'cp-001',
        label:      "Maccas Summer Creative — Fullscreen",
        contentId:  null,   // links to content library item when uploaded
        format:     'fullscreen',
      ...
      {
        id:         'cp-002',
        label:      "Maccas Breakfast Promo — Fullscreen",
        contentId:  null,
        format:     'fullscreen',
        activeFrom: '2026-03-01',
        activeTo:   '2026-09-30',
      ...
      {
        id:         'cp-003',
        label:      "Maccas Game Day Special — L-wrap",
        contentId:  null,
        format:     'lwrap',
        activeFrom: '2026-03-01',
        activeTo:   '2026-09-30',
    ...
    notes:       "Primary season sponsorship — AFL home games plus background rotation.",
  },
];
